<section>
  <div class="presentation_brasserie">
  ...
  <div class="brassage">
    <div class="titre_etape">
      <h1>Comment brassons-nous les bières d'Osmose ?</h1>
      <h4>Les 8 étapes de la réalisation d'une bière :</h4>
    </div>
    <div class="etape">
      <div class="explications_etapes">
        <h2>Etape 1 : Le Maltage</h2>
    ...
    <div class="etape">
      ...
      <div class="explications_etapes">
        ...
        <p>Après le maltage, les grains maltés doivent être concassés pour briser leur enveloppe extérieure et permettre un accès facile aux enzymes et aux sucres. Le concassage permet d'obtenir un mélange de grains concassés appelé "mouture".</p>
      </div>
    </div>

    <div class="etape">
      <div class="explications_etapes">
        <h2>Etape 3 : L'Empâtage</h2>
    ...
    <div class="etape">
      ...
      <div class="explications_etapes">
        ...
        <p>C’est à ce moment-là que l’amidon contenu dans le malt se transforme en sucres simples fermentescibles. Pour cela, la maische est chauffée afin d’activer les enzymes. On obtient ainsi un moût sucré grâce à la transformation de l’amidon en sucres. Ce moût est placé dans une cuve d’ébullition où il est cuit et stérilisé. C’est lors de cette étape que les brasseurs ajoutent le houblon et parfois quelques autres ingrédients secrets qui font la particularité de chaque bière.</p>
      </div>
    </div>

    <div class="etape">
      <div class="explications_etapes">
        <h2>Etape 5 : La Fermentation</h2>
    ...
    <div class="etape">
      ...
      <div class="explications_etapes">
        ...
        <p>La maturation est une étape cruciale où la bière est laissée à reposer pendant une période plus ou moins longue pour permettre aux saveurs de se développer et aux levures et autres sédiments de se déposer au fond du fermenteur. Cette étape contribue à affiner le goût de la bière et à améliorer sa clarté.</p>
      </div>
    </div>

    <div class="etape">
      <div class="explications_etapes">
        <h2>Etape 7 : La Filtration</h2>
    ...
    <div class="etape">
      ...
      <div class="explications_etapes">
        ...
        <p>Enfin, la bière est prête pour l'étape finale : le conditionnement. Elle est transférée dans des fûts, des bouteilles ou des canettes, prête à être distribuée et dégustée.</p>
      </div>
